...
## step1. python im2rec.py --list --recursive --num-thread 8 [name of .lst (output)] [path to image dataset folder]
## step2. python im2rec.py --pack-label --pass-through --recursive --num-thread 8 --prefix [name of .lst from step1] --root [path to image dataset folder]
